...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/25 17:11:42 by hozkaya           #+#    #+#             */
/*   Updated: 2024/08/25 17:11:43 by hozkaya          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (this->energy == 0)
    {
        std::cout << "ClapTrap " <<this->get_name() << " has no energy to attack! 3"<< std::endl;
        return;
    }
